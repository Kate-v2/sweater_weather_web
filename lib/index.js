...
// ---- Session ----
  ...
  function registerForm(element) {
    ...
    let email = addDiv(form, 'email', 'row' )
      ...
      field.appendChild( makeInput(field, 'emailField', null) )
    ...
    let password = addDiv(form, 'password', 'row' )
      ...
      field.appendChild( makeInput(field, 'passwordField', null) )
    ...
    let confirm = addDiv(form, 'confrim', 'row' )
      ...
      field.appendChild( makeInput(field, 'confirmField', null) )
  }
...
function displayForecast(data){
  ...
  function displayToday(data, element) {
    ...
    let today1 = addSpan(showToday, 'today1_temp', 'today')
      // let today1_1 = addSpan(today1, 'today1_1', 'today1')
    ...
    let today3 = addSpan(showToday, 'today2_location', 'today')
      // let today3_1 = addSpan(today3, 'today3_1', 'today3')
...
function addSessionButton(nav) {
  ...
  // submit.addEventListener('click', function() { newSession() } )
  // submit.addEventListener('click', function() { clearSession() } )
